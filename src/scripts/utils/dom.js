...
export const {
  ready, $, $$, addClass, removeClass, toggleClass, hasClass,
  on, off, trigger, html, text, attr, removeAttr, data, css,
  show, hide, isVisible, fadeIn, fadeOut, slideUp, slideDown,
  append, prepend, remove, offset, position, width, height,
  closest, siblings, ajax
} = DOM